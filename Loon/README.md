# Loon 使用教程（对齐 Clash Party v5.4.39）

> 目录简介：这里维护 Loon iOS 配置和使用教程，按 Loon 原生语法对齐 Clash Party 分流策略。
>
> 配置文件：`Loon/Loon.conf`
> 版本：**v5.4.39-Loon.1**（Build 2026-07-09，详见 `Loon/CHANGELOG.md`；跟随 Clash Party v5.4.39 基线）
...
1. Loon → **首页** → 应显示 `Loon Smart v5.4.39-Loon.1`，协议已启用。
