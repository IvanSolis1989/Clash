# Passwall / Passwall2 使用教程（对齐 Clash Party v5.4.40 简化版）

> 目录简介：这里提供 Passwall2 精简分流版的展平 shunt rule 配置和 OpenWrt 使用教程。
>
> 配置参考：`Passwall2/` 目录  
> 版本：**v5.4.40-pw2.1**（Build 2026-07-09；基线：Clash Party v5.4.40；变更历史：见 `Passwall2/CHANGELOG.md`；展平降级参考，无自动区域测速字段）
