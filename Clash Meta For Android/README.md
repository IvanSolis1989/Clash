...
> 当前版本：**v6.0.7-cmfa.1**（Build 2026-07-14，跟随 Clash Party v6.0.7 主线；区域 url-test 与 provider health-check 默认 300s）
...
- ✅ 143 条主规则 + 126 个融合 `rule-providers` 全部由 source graph 顺序编译生成。
