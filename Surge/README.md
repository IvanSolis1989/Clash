# Surge 使用教程（对齐 Clash Party v6.0.4）

> 目录简介：这里维护 Surge iOS/macOS 配置和导入教程，按 Surge 语法对齐 Clash Party 分流策略。
>
> 配置文件：`Surge/Surge.conf`
> 版本：**v6.0.4-Surge.1**（Build 2026-07-13，详见 `Surge/CHANGELOG.md`；跟随 Clash Party v6.0.4 基线；68 个源语义段对应 64 个非空远程 RULE-SET）
...
1. Surge → **首页** → **已启用的配置**：应显示 `Surge Smart v6.0.4-Surge.1`。
