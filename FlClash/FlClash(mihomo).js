...
// 版本：v5.4.38-flclash.1 (2026-07-09)
// 架构：22 url-test 区域组（11 全部 + 11 家宽）+ 33 业务策略组（含 14 流媒体平台组）+ 429 rule-providers 100%+ 服务覆盖
// 基线：Clash Party v5.4.38（规则 100% 等价；区域组为 url-test — FlClash 内核为标准 Mihomo，不支持 smart + LightGBM）
...
const VERSION = 'v5.4.38-flclash.1'
...
const MIHOMO_MRS_PROVIDER_MAP = {
  ...
  "acc-appleai": {
    "behavior": "domain",
    "file": "acc-appleai.mrs"
  },
  "acc-applenews": {
    "behavior": "domain",
    "file": "acc-applenews.mrs"
  },
  "acc-aqara-cn": {
    "behavior": "domain",
    "file": "acc-aqara-cn.mrs"
  },
  "acc-baidunetdisk": {
    "behavior": "domain",
    "file": "acc-baidunetdisk.mrs"
  },
  "acc-bank-au": {
    "behavior": "domain",
    "file": "acc-bank-au.mrs"
  },
  "acc-bank-ca": {
    "behavior": "domain",
    "file": "acc-bank-ca.mrs"
  },
  "acc-bank-de": {
    "behavior": "domain",
    "file": "acc-bank-de.mrs"
  },
  "acc-bank-fr": {
    "behavior": "domain",
    "file": "acc-bank-fr.mrs"
  },
  "acc-bank-hk": {
    "behavior": "domain",
    "file": "acc-bank-hk.mrs"
  },
  "acc-bank-jp": {
    "behavior": "domain",
    "file": "acc-bank-jp.mrs"
  },
  "acc-bank-nl": {
    "behavior": "domain",
    "file": "acc-bank-nl.mrs"
  },
  "acc-bank-sg": {
    "behavior": "domain",
    "file": "acc-bank-sg.mrs"
  },
  "acc-bank-uk": {
    "behavior": "domain",
    "file": "acc-bank-uk.mrs"
  },
  "acc-bank-us": {
    "behavior": "domain",
    "file": "acc-bank-us.mrs"
  },
  "acc-blockhttpdnsplus": {
    "behavior": "domain",
    "file": "acc-blockhttpdnsplus.mrs"
  },
  "acc-chinamax": {
    "behavior": "domain",
    "file": "acc-chinamax.mrs"
  },
  "acc-copilot": {
    "behavior": "domain",
    "file": "acc-copilot.mrs"
  },
  "acc-emuleserver": {
    "behavior": "ipcidr",
    "file": "acc-emuleserver.mrs"
  },
  "acc-fastly": {
    "behavior": "ipcidr",
    "file": "acc-fastly.mrs"
  ...
  "acc-fl-kuaishou": {
    "behavior": "domain",
    "file": "acc-fl-kuaishou.mrs"
  },
  "acc-fl-weibo": {
    "behavior": "domain",
    "file": "acc-fl-weibo.mrs"
  },
  "acc-fl-xigua": {
    "behavior": "domain",
    "file": "acc-fl-xigua.mrs"
  },
  "acc-gemini": {
    "behavior": "domain",
    "file": "acc-gemini.mrs"
  ...
  "acc-geo-d-africa-central": {
    "behavior": "domain",
    "file": "acc-geo-d-africa-central.mrs"
  },
  "acc-geo-d-africa-east": {
    "behavior": "domain",
    "file": "acc-geo-d-africa-east.mrs"
  },
  "acc-geo-d-africa-north": {
    "behavior": "domain",
    "file": "acc-geo-d-africa-north.mrs"
  },
  "acc-geo-d-africa-south": {
    "behavior": "domain",
    "file": "acc-geo-d-africa-south.mrs"
  },
  "acc-geo-d-africa-west": {
    "behavior": "domain",
    "file": "acc-geo-d-africa-west.mrs"
  },
  "acc-geo-d-america-north": {
    "behavior": "domain",
    "file": "acc-geo-d-america-north.mrs"
  },
  "acc-geo-d-america-south": {
    "behavior": "domain",
    "file": "acc-geo-d-america-south.mrs"
  },
  "acc-geo-d-antarctica": {
    "behavior": "domain",
    "file": "acc-geo-d-antarctica.mrs"
  },
  "acc-geo-d-asia-central": {
    "behavior": "domain",
    "file": "acc-geo-d-asia-central.mrs"
  },
  "acc-geo-d-asia-china": {
    "behavior": "domain",
    "file": "acc-geo-d-asia-china.mrs"
  },
  "acc-geo-d-asia-east": {
    "behavior": "domain",
    "file": "acc-geo-d-asia-east.mrs"
  },
  "acc-geo-d-asia-eastsouth": {
    "behavior": "domain",
    "file": "acc-geo-d-asia-eastsouth.mrs"
  },
  "acc-geo-d-asia-south": {
    "behavior": "domain",
    "file": "acc-geo-d-asia-south.mrs"
  },
  "acc-geo-d-asia-west": {
    "behavior": "domain",
    "file": "acc-geo-d-asia-west.mrs"
  },
  "acc-geo-d-europe-east": {
    "behavior": "domain",
    "file": "acc-geo-d-europe-east.mrs"
  },
  "acc-geo-d-europe-west": {
    "behavior": "domain",
    "file": "acc-geo-d-europe-west.mrs"
  },
  "acc-geo-d-oceania": {
    "behavior": "domain",
    "file": "acc-geo-d-oceania.mrs"
  },
  "acc-grok": {
    "behavior": "domain",
    "file": "acc-grok.mrs"
  ...
  "acc-homeip-jp": {
    "behavior": "domain",
    "file": "acc-homeip-jp.mrs"
  },
  "acc-homeip-us": {
    "behavior": "domain",
    "file": "acc-homeip-us.mrs"
  },
  "acc-kwai": {
    "behavior": "domain",
    "file": "acc-kwai.mrs"
  ...
  "acc-macappupgrade": {
    "behavior": "domain",
    "file": "acc-macappupgrade.mrs"
  },
  "acc-microsoftapps": {
    "behavior": "domain",
    "file": "acc-microsoftapps.mrs"
  },
  "acc-parsec": {
    "behavior": "domain",
    "file": "acc-parsec.mrs"
  ...
  "acc-pornhub": {
    "behavior": "domain",
    "file": "acc-pornhub.mrs"
  },
  "acc-prerepaireasyprivacy": {
    "behavior": "domain",
    "file": "acc-prerepaireasyprivacy.mrs"
  },
  "acc-rustdesk": {
    "behavior": "domain",
    "file": "acc-rustdesk.mrs"
  },
  "acc-signal": {
    "behavior": "domain",
    "file": "acc-signal.mrs"
  ...
  "acc-unsupportvpn": {
    "behavior": "domain",
    "file": "acc-unsupportvpn.mrs"
  },
  "acc-vf-monzo": {
    "behavior": "domain",
    "file": "acc-vf-monzo.mrs"
  },
  "acc-vf-revolut": {
    "behavior": "domain",
    "file": "acc-vf-revolut.mrs"
  },
  "acc-vf-wise": {
    "behavior": "domain",
    "file": "acc-vf-wise.mrs"
  },
  "adobe": {
    "behavior": "domain",
    "file": "adobe.mrs"
  ...
  "cryptocurrency": {
    "behavior": "domain",
    "file": "cryptocurrency.mrs"
  },
  "dailymotion": {
    "behavior": "domain",
    "file": "dailymotion.mrs"
  },
  "dandanplay": {
    "behavior": "domain",
    "file": "dandanplay.mrs"
  ...
  "sublimetext": {
    "behavior": "domain",
    "file": "sublimetext.mrs"
  },
  "sukka-phishing": {
    "behavior": "domain",
    "file": "sukka-phishing.mrs"
  },
  "systemota": {
    "behavior": "domain",
    "file": "systemota.mrs"
  ...
  "szkane-edutools": {
    "behavior": "domain",
    "file": "szkane-edutools.mrs"
  },
  "szkane-khan": {
    "behavior": "domain",
    "file": "szkane-khan.mrs"
  },
  "szkane-netflixip": {
    "behavior": "ipcidr",
    "file": "szkane-netflixip.mrs"
  },
  "szkane-uk": {
    "behavior": "domain",
    "file": "szkane-uk.mrs"
  ...
  "tigerfintech": {
    "behavior": "domain",
    "file": "tigerfintech.mrs"
  },
  "truthsocial": {
    "behavior": "domain",
    "file": "truthsocial.mrs"
  },
  "tumblr": {
    "behavior": "domain",
    "file": "tumblr.mrs"
  ...
  "wankahuanju": {
    "behavior": "domain",
    "file": "wankahuanju.mrs"
  },
  "wanmeishijie": {
    "behavior": "domain",
    "file": "wanmeishijie.mrs"
  },
  "weibo": {
    "behavior": "domain",
    "file": "weibo.mrs"
...
const MIHOMO_MRS_SPLIT_PROVIDER_MAP = {
  "acc-apple": {
    "domain": "acc-apple-domain.mrs",
    "ipcidr": "acc-apple-ipcidr.mrs"
  },
  "acc-aqara-global": {
    "domain": "acc-aqara-global-domain.mrs",
    "ipcidr": "acc-aqara-global-ipcidr.mrs"
  },
  "acc-fl-bilibili": {
    "domain": "acc-fl-bilibili-domain.mrs",
    "ipcidr": "acc-fl-bilibili-ipcidr.mrs"
  },
  "acc-fl-douban": {
    "domain": "acc-fl-douban-domain.mrs",
    "ipcidr": "acc-fl-douban-ipcidr.mrs"
  },
  "acc-fl-tieba": {
    "domain": "acc-fl-tieba-domain.mrs",
    "ipcidr": "acc-fl-tieba-ipcidr.mrs"
  },
  "acc-fl-xianyu": {
    "domain": "acc-fl-xianyu-domain.mrs",
    "ipcidr": "acc-fl-xianyu-ipcidr.mrs"
  },
  "acc-fl-zhihu": {
    "domain": "acc-fl-zhihu-domain.mrs",
    "ipcidr": "acc-fl-zhihu-ipcidr.mrs"
  },
  "acc-hijackingplus": {
    "domain": "acc-hijackingplus-domain.mrs",
    "ipcidr": "acc-hijackingplus-ipcidr.mrs"
  },
  "acc-waybackmachine": {
    "domain": "acc-waybackmachine-domain.mrs",
    "ipcidr": "acc-waybackmachine-ipcidr.mrs"
  },
  "acc-weiyun": {
    "domain": "acc-weiyun-domain.mrs",
    "ipcidr": "acc-weiyun-ipcidr.mrs"
  },
  "adobeactivation": {
    "domain": "adobeactivation-domain.mrs",
    "ipcidr": "adobeactivation-ipcidr.mrs"
  },
  "advertising": {
    "domain": "advertising-domain.mrs",
    "ipcidr": "advertising-ipcidr.mrs"
  },
  "asianmedia": {
    "domain": "asianmedia-domain.mrs",
    "ipcidr": "asianmedia-ipcidr.mrs"
  },
  "blizzard": {
    "domain": "blizzard-domain.mrs",
    "ipcidr": "blizzard-ipcidr.mrs"
  },
  "blockhttpdns": {
    "domain": "blockhttpdns-domain.mrs",
    "ipcidr": "blockhttpdns-ipcidr.mrs"
  },
  "cloudflare": {
    "domain": "cloudflare-domain.mrs",
    "ipcidr": "cloudflare-ipcidr.mrs"
  },
  "clubhouseip": {
    "domain": "clubhouseip-domain.mrs",
    "ipcidr": "clubhouseip-ipcidr.mrs"
  },
  "dmm": {
    "domain": "dmm-domain.mrs",
    "ipcidr": "dmm-ipcidr.mrs"
  },
  "ehgallery": {
    "domain": "ehgallery-domain.mrs",
    "ipcidr": "ehgallery-ipcidr.mrs"
  },
  "googlefcm": {
    "domain": "googlefcm-domain.mrs",
    "ipcidr": "googlefcm-ipcidr.mrs"
  },
  "hijacking": {
    "domain": "hijacking-domain.mrs",
    "ipcidr": "hijacking-ipcidr.mrs"
  },
  "kakaotalk": {
    "domain": "kakaotalk-domain.mrs",
    "ipcidr": "kakaotalk-ipcidr.mrs"
  },
  "kugoukuwo": {
    "domain": "kugoukuwo-domain.mrs",
    "ipcidr": "kugoukuwo-ipcidr.mrs"
  },
  "lg": {
    "domain": "lg-domain.mrs",
    "ipcidr": "lg-ipcidr.mrs"
  },
  "line": {
    "domain": "line-domain.mrs",
    "ipcidr": "line-ipcidr.mrs"
  },
  "neteasemusic": {
    "domain": "neteasemusic-domain.mrs",
    "ipcidr": "neteasemusic-ipcidr.mrs"
  },
  "nintendo": {
    "domain": "nintendo-domain.mrs",
    "ipcidr": "nintendo-ipcidr.mrs"
  },
  "privacy": {
    "domain": "privacy-domain.mrs",
    "ipcidr": "privacy-ipcidr.mrs"
  },
  "privatetracker": {
    "domain": "privatetracker-domain.mrs",
    "ipcidr": "privatetracker-ipcidr.mrs"
  },
  "qobuz": {
    "domain": "qobuz-domain.mrs",
    "ipcidr": "qobuz-ipcidr.mrs"
  },
  "supercell": {
    "domain": "supercell-domain.mrs",
    "ipcidr": "supercell-ipcidr.mrs"
  },
  "szkane-bilihmt": {
    "domain": "szkane-bilihmt-domain.mrs",
    "ipcidr": "szkane-bilihmt-ipcidr.mrs"
  },
  "szkane-proxygfw": {
    "domain": "szkane-proxygfw-domain.mrs",
    "ipcidr": "szkane-proxygfw-ipcidr.mrs"
  },
  "teamviewer": {
    "domain": "teamviewer-domain.mrs",
    "ipcidr": "teamviewer-ipcidr.mrs"
  },
  "tencentvideo": {
    "domain": "tencentvideo-domain.mrs",
    "ipcidr": "tencentvideo-ipcidr.mrs"
  },
  "whatsapp": {
    "domain": "whatsapp-domain.mrs",
    "ipcidr": "whatsapp-ipcidr.mrs"
  },
  "yandex": {
    "domain": "yandex-domain.mrs",
    "ipcidr": "yandex-ipcidr.mrs"
  },
  "youku": {
    "domain": "youku-domain.mrs",
    "ipcidr": "youku-ipcidr.mrs"
  }
}
