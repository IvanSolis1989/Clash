...
// 版本：v5.4.40-flclash.1 (2026-07-09)
// 架构：22 url-test 区域组（11 全部 + 11 家宽）+ 33 业务策略组 + 120 融合 rule-providers / 130 rules
// 基线：Clash Party v5.4.40（规则 100% 等价；区域组为 url-test — FlClash 内核为标准 Mihomo，不支持 smart + LightGBM）
...
const VERSION = 'v5.4.40-flclash.1'
...
function injectRules(config) {
  ...
  for (var i = 0; i < nextRules.length; i++) config.rules.push(nextRules[i])
