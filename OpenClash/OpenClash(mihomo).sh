...
# ============================================================================
# Clash Smart v6.0.11-oc-normal.5 — OpenClash 覆写脚本（非 Smart 内核 / url-test 区域组）
# Build: 2026-08-22
# ============================================================================
# v6.0.11-oc-normal.5: Gemini 与 Accademia Gemini 规则集改走 Google 服务；szkane-ai 顺序和 AI 目标保持不变
...
VERSION_TAG="v6.0.11-oc-normal.5"
CONFIG_FILE="$1"
