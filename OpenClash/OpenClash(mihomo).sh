...
# ============================================================================
# Clash Smart v5.4.38-oc-normal.1 — OpenClash 覆写脚本（非 Smart 内核 / url-test 区域组）
# Build: 2026-07-09
# ============================================================================
...
#   • 391 rule-providers（全部 proxy: "🚫 受限网站"，对齐 Clash Party FIX#17-P0）
#   • 846 条 rules
#   • DNS fake-ip + 嗅探（HTTP/TLS/QUIC）+ nameserver-policy 救援
#   • Ruby 阶段做：节点过滤 / 区域分类 / url-test 组生成 / TLS 指纹注入
# 基线：Clash Party v5.4.38（唯一主线；v5.3.1/v5.3.2 为桌面端 PROCESS-NAME 改动，路由器端不适用）── 任何规则/组/DNS 改动必须先改 Clash Party JS，
...
VERSION_TAG="v5.4.38-oc-normal.1"
CONFIG_FILE="$1"
...
LOG_OUT "Info" "[Clash-Normal] Full-rule build (v5.4.38, 33 business groups, non-Smart kernel)"
...
# ============================================================================
# OVERRIDE YAML (续) — Rule-Providers：391 项，对齐 Clash Party v5.4.38 主线
# 策略：
#   ✓ 与 Clash Party 主线（BIZ.GFW = '🚫 受限网站'）一致：所有 provider 都走 GFW 组
#     下载，在中国走代理、在印尼走 DIRECT，规避 jsdelivr/GitHub 冷启动死锁。
#   ✓ 22 url-test 区域组 + 33 业务组 + 391 rule-providers + 846 条规则
...
rule-providers:
  ...
  scki-adfp-direct:
    ...
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/adfp-direct.list
    path: ./ruleset/scki-adfp-direct.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-adfp-intl-site:
    type: http
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/adfp-intl-site.list
    path: ./ruleset/scki-adfp-intl-site.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-adfp-payments:
    type: http
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/adfp-payments.list
    path: ./ruleset/scki-adfp-payments.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-cnmedia-guard:
    type: http
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/cnmedia-guard.list
    path: ./ruleset/scki-cnmedia-guard.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-local-direct:
    type: http
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/local-direct.list
    path: ./ruleset/scki-local-direct.list
    interval: 604800
    proxy: "🚫 受限网站"
  ...
  scki-gfw-guard:
    ...
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/gfw-guard.list
    path: ./ruleset/scki-gfw-guard.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-youtube-guard:
    type: http
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/youtube-guard.list
    path: ./ruleset/scki-youtube-guard.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-google-mail-intl:
    ...
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/google-mail-intl.list
    path: ./ruleset/scki-google-mail-intl.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-google-work:
    type: http
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/google-work.list
    path: ./ruleset/scki-google-work.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-download-guard:
    type: http
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/download-guard.list
    path: ./ruleset/scki-download-guard.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-cnsite-guard:
    type: http
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/cnsite-guard.list
    path: ./ruleset/scki-cnsite-guard.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-work-guard:
    type: http
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/work-guard.list
    path: ./ruleset/scki-work-guard.list
    interval: 604800
    proxy: "🚫 受限网站"
  scki-ai-supplement:
    type: http
    behavior: classical
    format: text
    url: https://fastly.jsdelivr.net/gh/IvanSolis1989/Smart-Config-Kit@main/rulesets/supplemental/clash/ai-supplement.list
    path: ./ruleset/scki-ai-supplement.list
    interval: 604800
    proxy: "🚫 受限网站"
rules:
...
- "RULE-SET,scki-local-direct,DIRECT"
...
- "RULE-SET,vpsdance-ai-coding,🤖 AI 服务"
...
- "RULE-SET,unity,🔧 工具与服务"
- "RULE-SET,szkane-developer,🔧 工具与服务"
