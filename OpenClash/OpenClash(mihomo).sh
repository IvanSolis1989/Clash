...
# ============================================================================
# Clash Smart v6.0.12-oc-normal.6 — OpenClash 覆写脚本（非 Smart 内核 / url-test 区域组）
# Build: 2026-09-01
# ============================================================================
# v6.0.12-oc-normal.6: NVIDIA 中国账号登录域名 login.nvidia.cn 精确直连前置；其余 NVIDIA 下载/开发域名仍走下载组
...
VERSION_TAG="v6.0.12-oc-normal.6"
CONFIG_FILE="$1"
