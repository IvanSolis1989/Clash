...
# ============================================================================
# Clash Smart v6.0.9-oc-normal.1 — OpenClash 覆写脚本（非 Smart 内核 / url-test 区域组）
# Build: 2026-07-19
# ============================================================================
...
VERSION_TAG="v6.0.9-oc-normal.1"
CONFIG_FILE="$1"
...
#   ✓ 22 url-test 区域组 + 33 业务组 + 127 融合 rule-providers + 146 条规则
