...
# ============================================================================
# Clash Smart v6.0.5-oc-normal.1 — OpenClash 覆写脚本（非 Smart 内核 / url-test 区域组）
# Build: 2026-07-14
# ============================================================================
...
VERSION_TAG="v6.0.5-oc-normal.1"
CONFIG_FILE="$1"
...
LOG_OUT "Info" "[Clash-Normal] Fused-rule build (v6.0.5, 33 business groups, non-Smart kernel)"
