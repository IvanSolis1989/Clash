...
# ============================================================================
# Clash Smart v6.0.9-oc-smart.3 — OpenClash 覆写脚本（与 Clash Party 主线同等规则量）
# Build: 2026-07-25
# ============================================================================
# v6.0.9-oc-smart.3: Node-DNS profile 仅控制受限投影深度；规则、组与全局 DNS 基线不变
...
# 定位：对齐 Clash Party v6.0.9 JS 主线的 OpenClash 全量版本。v5.4.2: P0-FIX#41 小米白名单。
