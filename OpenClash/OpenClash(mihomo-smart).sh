...
# ============================================================================
# Clash Smart v5.4.39-oc-smart.1 — OpenClash 覆写脚本（与 Clash Party 主线同等规则量）
# Build: 2026-07-09
# ============================================================================
...
# 定位：对齐 Clash Party v5.4.39 JS 主线的 OpenClash 全量版本。v5.4.2: P0-FIX#41 小米白名单。
...
VERSION_TAG="v5.4.39-oc-smart.1"
CONFIG_FILE="$1"
...
#   ✓ 22 Smart 区域组 + 33 业务组 + 474 rule-providers + 929 条规则
