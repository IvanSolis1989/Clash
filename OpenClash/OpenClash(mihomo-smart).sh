...
# ============================================================================
# Clash Smart v6.0.13-oc-smart.7 — OpenClash 覆写脚本（与 Clash Party 主线同等规则量）
# Build: 2026-09-03
# ============================================================================
# v6.0.13-oc-smart.7: LINUX DO 大陆备用域名 linuxdo.org 前置归入国内网站；主站 linux.do 保持受限网站
...
# 定位：对齐 Clash Party v6.0.13 JS 主线的 OpenClash 全量版本。v5.4.2: P0-FIX#41 小米白名单。
...
VERSION_TAG="v6.0.13-oc-smart.7"
CONFIG_FILE="$1"
