...
# ============================================================================
# Clash Smart v6.0.9-oc-smart.1 — OpenClash 覆写脚本（与 Clash Party 主线同等规则量）
# Build: 2026-07-19
# ============================================================================
# v6.0.9: api.github.com 默认进入工具组；路由器内核无进程匹配能力，不保留桌面 Copilot 例外
