...
# ============================================================================
# Clash Smart v6.0.9-oc-smart.4 — OpenClash 覆写脚本（与 Clash Party 主线同等规则量）
# Build: 2026-08-02
# ============================================================================
# v6.0.9-oc-smart.4: 小写 ISO 两位码加数字后缀可稳定进入对应区域组；规则、组与全局 DNS 基线不变
