# Quantumult X 使用教程（对齐 Clash Party v5.4.39）

> 目录简介：这里维护 Quantumult X iOS 配置和导入教程，按 QX 的 policy/filter 语法对齐 Clash Party 基线。
>
> 配置文件：`Quantumult X/QuantumultX.conf`
> 版本：**v5.4.39-QX.1**（Build 2026-07-09，详见 `Quantumult X/CHANGELOG.md`；跟随 Clash Party v5.4.39 基线）
...
1. QX → **设置** → **配置** → 查看当前配置名称，应显示 `Quantumult X Smart v5.4.39-QX.1`。
