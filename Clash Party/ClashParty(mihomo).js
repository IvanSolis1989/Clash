...
// 版本：v6.0.12-normal.6 (2026-09-01)
// 架构：22 url-test 区域组（11 全部 + 11 家宽）+ 33 业务策略组 + 132 融合 rule-providers / 151 rules
// 规则源：rulesets/source/routing-graph.js v6.0.12（与 Smart 版规则 100% 等价，仅区域组从 smart 改为 url-test）
// v6.0.12-normal.6：NVIDIA 中国账号登录域名 login.nvidia.cn 精确直连前置；其余 NVIDIA 下载/开发域名仍走下载组
...
const VERSION = 'v6.0.12-normal.6'
